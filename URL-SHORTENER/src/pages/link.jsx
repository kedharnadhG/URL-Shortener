      ...
      <div className="flex justify-between flex-col gap-8 sm:flex-row ">
        <div className="flex flex-col items-start gap-8 rounded-lg sm:w-2/5">
          ...
          <a
            ...
            target="_blank"
            className="text-3xl sm:text-4xl font-bold hover:underline cursor-pointer text-blue-400"
          >
          ...
          <img
            src={url?.qr}
            alt="qr-code"
            className="w-full object-contain ring ring-blue-500 p-1 self-center sm:self-start"
          />
        </div>
